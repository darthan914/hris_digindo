...
@section('content')
	...
	<h1>Buat Role</h1>
	<div class="x_panel">
	<form class="form-horizontal form-label-left" action="{{ route('admin.role.store') }}" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			...
			<div class="col-md-9 col-sm-9 col-xs-12">
				<label class="checkbox-inline"><input type="checkbox" name="permission[]" class="group-master" value="config" @if(in_array('config', old('permission', []))) checked @endif>Configuration</label>
				<ul class="parsley-errors-list filled">

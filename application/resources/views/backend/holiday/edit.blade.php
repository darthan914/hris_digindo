...
@section('content')
	...
	<h1>Libur - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.holiday.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">

			<div class="form-group">
				<label for="name" class="control-label col-md-3 col-sm-3 col-xs-12">Nama <span class="required">*</span>
				</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="name" name="name" class="form-control {{$errors->first('name') != '' ? 'parsley-error' : ''}}" value="{{ old('name') == '' ? $index->name : old('name') }}">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<label class="radio-inline"><input type="radio" id="type-libur" name="type" value="libur" @if(old('type') != '' && old('type') == 'libur') checked @elseif($index->type == 'libur' ) checked @endif>Libur</label> 
					<label class="radio-inline"><input type="radio" id="type-cuti" name="type" value="cuti" @if(old('type') != '' && old('type') == 'cuti') checked @elseif($index->type == 'cuti' ) checked @endif>Cuti Bersama</label> 
					<ul class="parsley-errors-list filled">

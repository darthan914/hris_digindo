...
@section('content')
	...
	<h1>Laporan Absen - {{ $absenceEmployee->employee->name or $absenceEmployee->id_machine }} - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.absence.updateAbsenceEmployeeDetail', ['id' => $absenceEmployee->id]) }}" method="post" enctype="multipart/form-data">
			{{ csrf_field() }}
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="schedule_in" name="schedule_in" class="form-control {{$errors->first('schedule_in') != '' ? 'parsley-error' : ''}}" value="{{ old('schedule_in', date('H:i', strtotime($index->schedule_in))) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="schedule_out" name="schedule_out" class="form-control {{$errors->first('schedule_out') != '' ? 'parsley-error' : ''}}" value="{{ old('schedule_out', date('H:i', strtotime($index->schedule_out))) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<select id="status" name="status" class="form-control {{$errors->first('status') != '' ? 'parsley-error' : ''}}">
						<option value="kosong" @if(old('status', $index->status) == 'kosong') selected @endif>Kosong</option>
						<option value="masuk" @if(old('status', $index->status) == 'masuk') selected @endif>Masuk</option>
						<option value="libur" @if(old('status', $index->status) == 'libur') selected @endif>Libur</option>
						<option value="cuti" @if(old('status', $index->status) == 'cuti') selected @endif>Cuti</option>
						<option value="izin" @if(old('status', $index->status) == 'izin') selected @endif>Izin</option>
						<option value="sakit" @if(old('status', $index->status) == 'sakit') selected @endif>Sakit</option>
						<option value="alpa" @if(old('status', $index->status) == 'alpa') selected @endif>Alpa</option>
					</select>
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<textarea id="status_note" name="status_note" class="form-control {{$errors->first('status_note') != '' ? 'parsley-error' : ''}}">{{ old('status_note', $index->status_note) }}</textarea>
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="for" name="point_overtime" class="form-control {{$errors->first('point_overtime') != '' ? 'parsley-error' : ''}}" value="{{ old('point_overtime', $index->point_overtime) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="for" name="gaji_pokok" class="form-control {{$errors->first('gaji_pokok') != '' ? 'parsley-error' : ''}}" value="{{ old('gaji_pokok', $index->gaji_pokok) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="for" name="fine_late" class="form-control {{$errors->first('fine_late') != '' ? 'parsley-error' : ''}}" value="{{ old('fine_late', $index->fine_late) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="for" name="fine_additional" class="form-control {{$errors->first('fine_additional') != '' ? 'parsley-error' : ''}}" value="{{ old('fine_additional', $index->fine_additional) }}">
					<ul class="parsley-errors-list filled">

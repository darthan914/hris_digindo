	...
	$(function() {
		...
		$(".btn-pulldata").click(function(){
	    	...
	    	else
	    	{
		        ...
		        {
		            id_employee: {{ $absence_employee->id_employee }},
...
@section('content')
	...
	<h1>Absen Check Karyawan - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.absence.updateEmployeeDetail', [$index->id]) }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="shift_in" name="shift_in" class="form-control {{$errors->first('shift_in') != '' ? 'parsley-error' : ''}}" value="{{ old('shift_in', $index->shift_in) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="shift_out" name="shift_out" class="form-control {{$errors->first('shift_out') != '' ? 'parsley-error' : ''}}" value="{{ old('shift_out', $index->shift_out) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="check_in" name="check_in" class="form-control {{$errors->first('check_in') != '' ? 'parsley-error' : ''}}" value="{{ old('check_in', $index->check_in) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="check_out" name="check_out" class="form-control {{$errors->first('check_out') != '' ? 'parsley-error' : ''}}" value="{{ old('check_out', $index->check_out) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="fine_additional" name="fine_additional" class="form-control {{$errors->first('fine_additional') != '' ? 'parsley-error' : ''}}" value="{{ old('fine_additional', $index->fine_additional) }}">
					<ul class="parsley-errors-list filled">

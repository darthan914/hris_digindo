	...
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.employeeFamily.store', ['id' => $employee->id]) }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<select id="relation" name="relation" class="form-control {{$errors->first('relation') != '' ? 'parsley-error' : ''}}">
						...
						<option value="suami" @if(old('relation') != '' && old('relation') == 'suami') selected @endif>Suami</option>
						<option value="istri" @if(old('relation') != '' && old('relation') == 'istri') selected @endif>Istri</option>
						<option value="anak" @if(old('relation') != '' && old('relation') == 'anak') selected @endif>Anak</option>
					</select>
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="age" name="age" class="form-control {{$errors->first('age') != '' ? 'parsley-error' : ''}}" value="{{ old('age') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="school" name="school" class="form-control {{$errors->first('school') != '' ? 'parsley-error' : ''}}" value="{{ old('school') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				<div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
					{{ csrf_field() }}
					<a class="btn btn-primary" href="{{ route('admin.employee.edit', ['id' => $employee->id]) }}">Batal</a>

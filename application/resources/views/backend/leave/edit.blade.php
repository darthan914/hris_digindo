...
@section('content')
	...
	<h1>Izin Meninggalkan Kantor - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.leave.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="start_time" name="start_time" class="form-control {{$errors->first('start_time') != '' ? 'parsley-error' : ''}}" value="{{ old('start_time') == '' ? $index->start_time : old('start_time') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="end_time" name="end_time" class="form-control {{$errors->first('end_time') != '' ? 'parsley-error' : ''}}" value="{{ old('end_time') == '' ? $index->end_time : old('end_time') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<textarea id="need" name="need" class="form-control {{$errors->first('need') != '' ? 'parsley-error' : ''}}">{{ old('need') == '' ? $index->need : old('need') }}</textarea>
					<ul class="parsley-errors-list filled">

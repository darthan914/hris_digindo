...
@section('content')
	...
	<h1>Peminjaman Barang - Edit</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.borrow.update', ['id' => $index->id]) }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="item" name="item" class="form-control {{$errors->first('item') != '' ? 'parsley-error' : ''}}" value="{{ old('item', $index->item) }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="date_borrow" name="date_borrow" class="form-control {{$errors->first('date_borrow') != '' ? 'parsley-error' : ''}}" value="{{ old('date_borrow', $index->date_borrow ? date('d F Y', strtotime($index->date_borrow)) : '') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="date_return" name="date_return" class="form-control {{$errors->first('date_return') != '' ? 'parsley-error' : ''}}" value="{{ old('date_return', $index->date_return, $index->date_return ? date('d F Y', strtotime($index->date_return)) : '') }}">
					<ul class="parsley-errors-list filled">
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-9 col-xs-12">
					<label class="checkbox-inline">
						<input type="checkbox" id="status" name="status" class="{{$errors->first('status') != '' ? 'parsley-error' : ''}}" @if(old('status', $index->status) == 1) checked @endif value="1">
						dipinjam
					</label>
					<ul class="parsley-errors-list filled">

...
@section('content')
	...
	<h1>Lembur - Buat</h1>
	<div class="x_panel">
		<form class="form-horizontal form-label-left" action="{{ route('admin.overtime.store') }}" method="post" enctype="multipart/form-data">
			...
			<div class="form-group">
				<label for="end_overtime" class="control-label col-md-3 col-sm-3 col-xs-12">Jam Lembur <span class="required">*</span>
				</label>
				<div class="col-md-9 col-sm-9 col-xs-12">
					<input type="text" id="end_overtime" name="end_overtime" class="form-control {{$errors->first('end_overtime') != '' ? 'parsley-error' : ''}}" value="{{ old('end_overtime') }}">
					<ul class="parsley-errors-list filled">

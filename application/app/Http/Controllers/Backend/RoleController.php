...
class RoleController extends Controller
{
    ...
    public function datatables(Request $request)
    {
        ...
        $datatables->addColumn('action', function ($index) {
        	...
        	{
        		$html .= '
	                <a href="' . route('admin.role.edit', ['id' => $index->id]) . '" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i></a>
	            ';
        	}
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.role')->with('success', 'Data Has Been Added');
    }
    ...
    public function update($id, Request $request)
    {
        ...
        return redirect()->route('admin.role')->with('success', 'Data Has Been Updated');
    }
